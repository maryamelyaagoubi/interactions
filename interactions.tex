...
0<\lambda<1,
\]
in order to reduce excessive turnover and avoid reacting too strongly to noisy covariance estimates. The activation term may be based on rolling prospective transmission:
\[
g_t
=
\mathbf 1_{\{L_t > \ell_0\}},
...
\]
Thus the hedge is active only when the proxy is currently transmitting information to ammonia.
